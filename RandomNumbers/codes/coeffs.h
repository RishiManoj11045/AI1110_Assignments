...
//Defining the function for calculating the mean of squares of random numbers
double mean_sqr(char *str)
{
int i=0,c;
FILE *fp;
...
//End function for calculating the mean of squares of random numbers
