...
plt.scatter(x.T, F, color="blue", label="Numerical" )#plotting the experimental CDF
plt.plot(x.T, F_theory, color="orange", label="Theoretical" )#plotting the theoretical CDF
plt.grid()
plt.minorticks_on()
plt.xlabel("x")
plt.ylabel("$F_U(x)$")
