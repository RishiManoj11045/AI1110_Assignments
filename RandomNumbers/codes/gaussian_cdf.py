...
plt.scatter(x.T, F, color="blue",label="Numerical" )   #plotting the empirical CDF
plt.plot(x.T, F_theory, color="orange", label="Theoretical" ) #plotting the experimental CDF
plt.grid()
plt.minorticks_on()
plt.xlabel("x")
plt.ylabel("$F_X(x)$")
